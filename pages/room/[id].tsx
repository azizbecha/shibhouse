          ...
          <div className="bg-gray-800 flex-1 flex flex-col space-y-5 lg:space-y-0 lg:flex-row lg:space-x-10 sm:p-6 sm:my-2 sm:mx-4 sm:rounded-2xl">
            ...
            <div className="flex-1 px-2 sm:px-0 w-100">
              ...
              <div className="mb-10 sm:mb-0 mt-10 grid gap-4 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                <div className="group bg-darker/30 py-20 px-4 flex flex-col space-y-2 items-center cursor-pointer rounded-md hover:bg-dark/40 hover:smooth-hover">
                ...
                <div className="relative group bg-darker py-10 sm:py-20 px-4 flex flex-col space-y-2 items-center cursor-pointer rounded-md hover:bg-dark/80 hover:smooth-hover">
