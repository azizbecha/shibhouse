                                    ...
                                    <Dialog.Panel className="relative bg-darker rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:max-w-lg sm:w-full">
                                        <form onSubmit={createNewRoom}>
                                            <div className="bg-darker px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                                ...
                                                <Divider />
                                                <span className="font-semibold">Room title <span className="text-primary">*</span></span><br />
                                                <input className="rounded w-full py-1 px-2 text-black mb-4" placeholder="Please enter the room title here" ref={roomTitleRef}  type="text" required /><br />

                                                <span className="font-semibold">Description <span className="text-primary">*</span></span><br />
                                                <textarea className="rounded w-full py-1 px-2 mb-4 text-black" placeholder="Please enter the room description here" ref={roomDescriptionRef} required /><br />

                                                <span className="font-semibold">Topics <span className="text-primary">*</span></span><br />
                                                <input className="rounded w-full py-1 px-2 mb-4 text-black" placeholder="Please enter the room topics here (splitted by space)" type="text" ref={roomTopicsRef} required /><br />
                                                
                                                <span className="font-semibold">Pinned link</span><br />
                                                <input className="rounded w-full py-1 px-2 mb-4 text-black" placeholder="Please enter the room pinned link here" ref={roomPinnedLinkRef} type="link" /><br />
                                            </div>
