                    ...
                    <div className="max-w-sm mx-auto bg-gray rounded-lg shadow-md py-4">
                        <div className="flex flex-col container pb-10">
                            ...
                            <div className="flex space-x-3 mt-3 mx-auto">
                                <span className="justify-left text-sm font-bold text-white">{currentUserData.followers.length} <span className="font-normal">Follower{currentUserData.followers.length == 1 ? null : 's'}</span></span>
                                <span className="justify-left text-sm font-bold text-white">{currentUserData.following.length} <span className="font-normal">following</span></span>
                                <span className="justify-left text-sm font-bold text-white">{currentUserData.claps} <span className="font-normal">Claps</span></span>
                            </div>
