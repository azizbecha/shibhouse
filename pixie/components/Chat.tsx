                    ...
                    <Fragment>
                        ...
                        <div className="mt-1 flex">
                            ...
                            <div className="w-1/12">
                                <button onClick={() => sendMessage()} className={`${message.length == 0 ? 'bg-gray cursor-default' : 'bg-primary cursor-pointer'} text-white p-1.5 mt-2 rounded mr-1`}><FaPaperPlane /></button>
                            </div>
                        </div>
                    </Fragment>
                ) : (
