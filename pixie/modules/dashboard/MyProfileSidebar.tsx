                ...
                <div className="w-full h-full py-2 items-center justify-center text-white text-xl rounded-md">
                    ...
                    <div className="mx-auto bg-gray rounded-lg shadow-md py-2">
                        <div className="flex flex-col container py-5 justify-center align-center">
                            <Link href={'/me'}>
                                <div className="uppercase text-white text-2xl font-semibold rounded-full mb-3 shadow-lg mx-auto cursor-pointer" style={{backgroundColor: currentUserData.avatarColor, padding: '20px'}}>
